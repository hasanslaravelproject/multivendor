...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 20:34:29 GMT -->
<head>
...
@foreach($packs as $st)
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{$st->pack_name}}</h5>
                    <p class="card-text">Price : {{$st->pack_price}}</p>
                    <p class="card-text">Validity :  {{$st->pack_validity}}</p>
                    <a href="{{URL::to('subscribe/'.$st->id)}}" class="btn btn-primary">Subscribe</a>
                </div>
            </div>
        </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 20:36:26 GMT -->
</html>
