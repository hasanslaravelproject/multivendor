...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 21:20:05 GMT -->
<head>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="post" action="{{URL::to('login')}}">
                                        @csrf
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 21:20:06 GMT -->
</html>
